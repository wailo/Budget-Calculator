...
BudgetCalculator::OutputWindow::OutputWindow(int totalIncome, int totalSpendings, int totalEssentials, int totalBills,
                                             int totalRecreations, int totalSavings)
{
    InitializeComponent();

    getVariables(totalIncome, totalSpendings, totalEssentials, totalBills, totalRecreations, totalSavings);
...
void BudgetCalculator::OutputWindow::getVariables(int const totalIncome, int const totalSpendings,
                                                  int const totalEssentials, int const totalBills,
...
{
    if (outputVariables.outputEssentials > ((outputVariables.outputIncome / 10) * 2.5))
    {
    ...
    if (outputVariables.outputBills > ((outputVariables.outputIncome / 10) * 2.5))
    {
    ...
    if (outputVariables.outputRecreations > ((outputVariables.outputIncome / 10) * 3))
    {
    ...
    if (outputVariables.outputSavings > ((outputVariables.outputIncome / 10) * 2))
    {
...
{
    this->essentialAllowance->Text = Convert::ToString((outputVariables.outputIncome / 10) * 2.5);
    this->billsAllowance->Text = Convert::ToString((outputVariables.outputIncome / 10) * 2.5);
    this->recreationAllowance->Text = Convert::ToString((outputVariables.outputIncome / 10) * 3);
    this->savingsAllowance->Text = Convert::ToString((outputVariables.outputIncome / 10) * 2);
    this->totalAllowance->Text = Convert::ToString(outputVariables.outputIncome);
    this->essentialSpending->Text = Convert::ToString(outputVariables.outputEssentials);
    this->billsSpending->Text = Convert::ToString(outputVariables.outputBills);
    this->recreationsSpending->Text = Convert::ToString(outputVariables.outputRecreations);
    this->savingsSpending->Text = Convert::ToString(outputVariables.outputSavings);
    this->totalSpending->Text = Convert::ToString(outputVariables.outputSpendings);
}
...
void BudgetCalculator::OutputWindow::InitializeComponent(void)
{
    ...
    this->totalAllowance->Font =
        (gcnew System::Drawing::Font(L"Impact", 21.75F, System::Drawing::FontStyle::Regular,
    ...
    this->essentialSpending->Font =
        (gcnew System::Drawing::Font(L"Impact", 14.25F, System::Drawing::FontStyle::Regular,
                                     System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
    ...
    series1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold,
                                                 System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
    ...
    series5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold,
                                                 System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
...
System::Void BudgetCalculator::OutputWindow::AnalyzeButton_Click(System::Object ^ sender, System::EventArgs ^ e)
{
    this->Hide();
}

System::Void BudgetCalculator::OutputWindow::button1_Click(System::Object ^ sender, System::EventArgs ^ e)
{
