...
BudgetCalculator::SavingsWindow::SavingsWindow(void)
{
    InitializeComponent();
}

System::Void BudgetCalculator::SavingsWindow::SavingsSaveButton_Click(System::Object ^ sender, System::EventArgs ^ e)
{
...
void BudgetCalculator::SavingsWindow::InitializeComponent(void)
{
