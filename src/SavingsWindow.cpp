...
BudgetCalculator::SavingsWindow::SavingsWindow(void) { InitializeComponent(); }
...
void BudgetCalculator::SavingsWindow::InitializeComponent(void) {
  ...
  this->SavingsSaveButton->Click +=
      gcnew System::EventHandler(this, &SavingsWindow::SavingsSaveButton_Click);
  //
  // panel2
  //
