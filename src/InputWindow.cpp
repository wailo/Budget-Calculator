...
int BudgetCalculator::InputWindow::getTotalEssentials()
{
    ...
    return essentialswindow->essentials.inputChildcareBill + essentialswindow->essentials.inputDebtsAndLoansBill +
           essentialswindow->essentials.inputGroceriesBill + essentialswindow->essentials.inputOtherEssentials +
           essentialswindow->essentials.inputPetsBill + essentialswindow->essentials.inputTransportationBill;
}
...
{
    return recreatiosnwindow->recreations.inputEatOutBill + recreatiosnwindow->recreations.inputGiftsBill +
           recreatiosnwindow->recreations.inputGymBill + recreatiosnwindow->recreations.inputHolidaysBill +
           recreatiosnwindow->recreations.inputOtherRecreations + recreatiosnwindow->recreations.inputTicketsBill;
}

int BudgetCalculator::InputWindow::getTotalSavings()
{

    return savingswindow->savings.inputCarRepairsBill + savingswindow->savings.inputEmergencyBill +
           savingswindow->savings.inputHomeRepairsBill + savingswindow->savings.inputOtherSavings;
}

int BudgetCalculator::InputWindow::getTotalSpendings()
{

    return getTotalEssentials() + getTotalBills() + getTotalRecreations() + getTotalSavings();
}
...
void BudgetCalculator::InputWindow::InitializeComponent(void)
{
    ...
    this->label1->Font =
        (gcnew System::Drawing::Font(L"Impact", 20.25F, System::Drawing::FontStyle::Bold,
    ...
    //
    this->income->Font =
        (gcnew System::Drawing::Font(L"Impact", 18, System::Drawing::FontStyle::Bold,
                                     System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
    ...
    this->panel5->BackColor =
        System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(24)),
    ...
    // EssentialsButton
    //
    this->EssentialsButton->BackColor =
        System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(24)),
                                         static_cast<System::Int32>(static_cast<System::Byte>(163)),
                                         static_cast<System::Int32>(static_cast<System::Byte>(246)));
    ...
    this->EssentialsButton->Font =
        (gcnew System::Drawing::Font(L"Impact", 27.75F, System::Drawing::FontStyle::Bold,
                                     System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
...
System::Void BudgetCalculator::InputWindow::BillsButton_Click(System::Object ^ sender, System::EventArgs ^ e)
{
    billswindow->Show();
}

System::Void BudgetCalculator::InputWindow::SavingsButton_Click(System::Object ^ sender, System::EventArgs ^ e)
{
    savingswindow->Show();
}

System::Void BudgetCalculator::InputWindow::RecreationsButton_Click(System::Object ^ sender, System::EventArgs ^ e)
{
    recreatiosnwindow->Show();
}

System::Void BudgetCalculator::InputWindow::EssentialsButton_Click(System::Object ^ sender, System::EventArgs ^ e)
{
    essentialswindow->Show();
}

System::Void BudgetCalculator::InputWindow::AnalyzeButton_Click(System::Object ^ sender, System::EventArgs ^ e)
{
    ...
    else
    {
        ...
        totalSpendings = getTotalSpendings();
        OutputWindow ^ outputwindow = gcnew OutputWindow(totalIncome, totalSpendings, totalEssentials, totalBills,
