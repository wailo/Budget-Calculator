...
using namespace std;
/* Summary for EssentialWindow
This header contains all the items and functions existing in essentials window.
*/
public
...
public:
  ...
  // Function to assign essentialsStruct variables to the values entered by user
  // in the GUI
private:
