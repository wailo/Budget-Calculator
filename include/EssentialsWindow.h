...
namespace BudgetCalculator {
	...
	/// </summary>
	public ref class EssentialsWindow : public System::Windows::Forms::Form
	{
	...
	private: System::Windows::Forms::RichTextBox^ OtherEssentials;
	protected:

	protected:

	private: System::Windows::Forms::RichTextBox^ DebtsAndLoansBill;
	...
	private: System::Windows::Forms::RichTextBox^ PetsBill;


	private: System::Windows::Forms::RichTextBox^ ChildcareBill;


	private: System::Windows::Forms::RichTextBox^ GroceriesBill;
	...
	private: System::Windows::Forms::RichTextBox^ TransportationBill;
	private: System::Windows::Forms::Button^ EssentialsSaveButton;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent()
		{
			...
			// OtherEssentials
			// 
			this->OtherEssentials->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
			...
			this->OtherEssentials->TextChanged += gcnew System::EventHandler(this, &EssentialsWindow::OtherEssentials_TextChanged);
			// 
			// DebtsAndLoansBill
			// 
			this->DebtsAndLoansBill->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
			...
			// PetsBill
			// 
			this->PetsBill->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
			...
			// ChildcareBill
			// 
			this->ChildcareBill->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
			...
			// GroceriesBill
			// 
			this->GroceriesBill->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
			...
			this->GroceriesBill->TextChanged += gcnew System::EventHandler(this, &EssentialsWindow::GroceriesBill_TextChanged);
			// 
			// label1
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &EssentialsWindow::label1_Click);
			// 
			// panel8
			// 
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Impact", 27.75F, System::Drawing::FontStyle::Bold));
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Impact", 27.75F, System::Drawing::FontStyle::Bold));
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Impact", 27.75F, System::Drawing::FontStyle::Bold));
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Impact", 27.75F, System::Drawing::FontStyle::Bold));
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Impact", 27.75F, System::Drawing::FontStyle::Bold));
			...
			// TransportationBill
			// 
			this->TransportationBill->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Impact", 27.75F, System::Drawing::FontStyle::Bold));
			...
			this->label2->Click += gcnew System::EventHandler(this, &EssentialsWindow::label2_Click);
			// 
			// EssentialsSaveButton
			// 
			this->EssentialsSaveButton->Font = (gcnew System::Drawing::Font(L"Impact", 27.75F, System::Drawing::FontStyle::Bold));
			...
			this->EssentialsSaveButton->Click += gcnew System::EventHandler(this, &EssentialsWindow::EssentialsSaveButton_Click);
			// 
			// panel2
			// 
...
private: System::Void GroceriesBill_TextChanged(System::Object^ sender, System::EventArgs^ e) {
}
private: System::Void OtherEssentials_TextChanged(System::Object^ sender, System::EventArgs^ e) {
}
private: System::Void EssentialsSaveButton_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	std::cout << to_string(inputChildcareBill + inputDebtsAndLoansBill + inputGroceriesBill + inputTransportationBill + inputPetsBill + inputOtherEssentials) << endl;
