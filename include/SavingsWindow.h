...
public:
  SavingsWindow(void) { InitializeComponent(); }
  ...
  // Structure to store savings expenses variables
  ...
  // Function to assign savingsStruct variables to the values entered by user in
  // the
  // GUI
private:
