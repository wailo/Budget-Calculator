...
This header contains all the items and functions existing in recreation window.
*/
public
...
public:
  ...
  // Structure to store recreations expenses variables
  ...
  // Function to assign recreationsStruct variables to the values entered by
  // user in the
  // GUI
private:
