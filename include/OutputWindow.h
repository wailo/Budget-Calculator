...
#pragma region Windows Form Designer generated code
  ...
  void InitializeComponent(void) {
    ...
    this->panel1->Paint += gcnew System::Windows::Forms::PaintEventHandler(
        this, &OutputWindow::panel1_Paint);
    //
    // label1
    //
    ...
    this->label1->Click +=
        gcnew System::EventHandler(this, &OutputWindow::label1_Click);
    //
    // panel2
    //
    ...
    this->panel2->Paint += gcnew System::Windows::Forms::PaintEventHandler(
        this, &OutputWindow::panel2_Paint);
    //
    // totalAllowance
    //
    ...
    this->totalAllowance->Click +=
        gcnew System::EventHandler(this, &OutputWindow::label9_Click_1);
    //
    // essentialSpending
    //
    ...
    this->savingsAllowance->Click +=
        gcnew System::EventHandler(this, &OutputWindow::savingsAllowance_Click);
    //
    // billsAllowance
    //
    ...
    this->savingsSpending->Click +=
        gcnew System::EventHandler(this, &OutputWindow::label11_Click);
    //
    // label8
    //
    ...
    this->label2->Click +=
        gcnew System::EventHandler(this, &OutputWindow::label2_Click);
    //
    // AnalyzeButton
    //
    ...
    this->colChart->Click +=
        gcnew System::EventHandler(this, &OutputWindow::chart1_Click_1);
    //
    // pieChart
    //
    ...
    series5->ChartType = System::Windows::Forms::DataVisualization::Charting::
        SeriesChartType::Pie;
    ...
    this->pieChart->Click +=
        gcnew System::EventHandler(this, &OutputWindow::chart2_Click);
    //
    // OutputWindow
    //
    ...
    this->Load +=
        gcnew System::EventHandler(this, &OutputWindow::OutputWindow_Load);
...
private:
  System::Void OutputWindow_Load(System::Object ^ sender,
                                 System::EventArgs ^ e) {}
...
private:
  System::Void panel2_Paint(System::Object ^ sender,
                            System::Windows::Forms::PaintEventArgs ^ e) {}
...
private:
  System::Void essentialSpending_Click(System::Object ^ sender,
                                       System::EventArgs ^ e) {}
...
private:
  System::Void label9_Click_1(System::Object ^ sender, System::EventArgs ^ e) {}

private:
  System::Void chart2_Click(System::Object ^ sender, System::EventArgs ^ e) {}

private:
  System::Void chart1_Click_1(System::Object ^ sender, System::EventArgs ^ e) {}

private:
  System::Void savingsAllowance_Click(System::Object ^ sender,
                                      System::EventArgs ^ e) {}
