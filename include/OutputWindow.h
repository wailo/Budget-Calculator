...
ref class OutputWindow : public System::Windows::Forms::Form {
  //################## MODIFIED CODE SECTION: START ##################
  /*This section outlines the manually created and modified code.
Any code outside this section is auto-generated by VS window Designer. */
public:
  // Constructor: I modified this constructor from taking void to taking int
  // userinput variables from InputWindow.
  OutputWindow(int totalIncome, int totalSpendings, int totalEssentials,
    ...
    //################## MODIFIED CODE SECTION: END ##################
  }
  //################## MODIFIED CODE SECTION: START ##################
  /*This section outlines the manually created and modified code.
  Any code outside this section is auto-generated by VS window Designer. */

  // Structure to store the user input variables from InputWindow.
