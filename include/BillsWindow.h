...
This header contains all the items and functions existing in bills window.
*/
public
...
Any code outside this section is auto-generated by VS window Designer. */
  ...
  // Structure to store essentials expenses variables
  ...
  // Function to assign billsStruct variables to the values entered by user in
  // the GUI
private:
