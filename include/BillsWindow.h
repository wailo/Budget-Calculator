...
namespace BudgetCalculator {
	...
	/// <summary>
	/// Summary for BillsWindow
	/// </summary>
	public ref class BillsWindow : public System::Windows::Forms::Form
	{
	public:
		BillsWindow(void)
		{
	...
	private: System::Windows::Forms::Button^ BillSaveButton;
	...
	private: System::Windows::Forms::RichTextBox^ ElectricityBill;

	private: System::Windows::Forms::Label^ label7;
	private: System::Windows::Forms::RichTextBox^ PhoneBill;

	private: System::Windows::Forms::Label^ label6;
	private: System::Windows::Forms::RichTextBox^ InternetBill;

	private: System::Windows::Forms::Label^ label5;
	private: System::Windows::Forms::RichTextBox^ RentBill;

	private: System::Windows::Forms::Label^ label4;
	private: System::Windows::Forms::RichTextBox^ GasBill;

	private: System::Windows::Forms::Label^ label3;
	private: System::Windows::Forms::RichTextBox^ WaterBill;

	private: System::Windows::Forms::Label^ label2;
	private: System::Windows::Forms::Label^ label9;
	private: System::Windows::Forms::RichTextBox^ OtherBill;

	private: System::Windows::Forms::Label^ label8;
	private: System::Windows::Forms::RichTextBox^ HealthInsuranceBill;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &BillsWindow::panel1_Paint);
			// 
			// label1
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &BillsWindow::label1_Click);
			// 
			// panel2
			// 
			...
			// BillSaveButton
			// 
			this->BillSaveButton->Font = (gcnew System::Drawing::Font(L"Impact", 27.75F, System::Drawing::FontStyle::Bold));
			...
			this->BillSaveButton->Click += gcnew System::EventHandler(this, &BillsWindow::BillSaveButton_Click);
			// 
			// panel8
			// 
			...
			// OtherBill
			// 
			this->OtherBill->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Impact", 27.75F, System::Drawing::FontStyle::Bold));
			...
			// HealthInsuranceBill
			// 
			this->HealthInsuranceBill->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
			...
			// PhoneBill
			// 
			this->PhoneBill->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
			...
			// InternetBill
			// 
			this->InternetBill->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Impact", 27.75F, System::Drawing::FontStyle::Bold));
			...
			this->label5->Click += gcnew System::EventHandler(this, &BillsWindow::label5_Click);
			// 
			// RentBill
			// 
			this->RentBill->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
			...
			// GasBill
			// 
			this->GasBill->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
			...
			// WaterBill
			// 
			this->WaterBill->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
			...
			// ElectricityBill
			// 
			this->ElectricityBill->Font = (gcnew System::Drawing::Font(L"Impact", 16.75F, System::Drawing::FontStyle::Bold));
...
private: System::Void BillSaveButton_Click(System::Object^ sender, System::EventArgs^ e) {
